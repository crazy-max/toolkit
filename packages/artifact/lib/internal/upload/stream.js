...
exports.WaterMarkedUploadStream = void 0;
exports.createRawFileUploadStream = createRawFileUploadStream;
...
class WaterMarkedUploadStream extends stream.Transform {
...
exports.WaterMarkedUploadStream = WaterMarkedUploadStream;
function createRawFileUploadStream(filePath) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (stats.isSymbolicLink()) {
            sourcePath = yield (0, promises_1.realpath)(filePath);
        }
