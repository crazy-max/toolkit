...
class CreateArtifactRequest$Type extends runtime_5.MessageType {
    constructor() {
        super("github.actions.results.api.v1.CreateArtifactRequest", [
            ...
            { no: 6, name: "mime_type", kind: "message", T: () => wrappers_2.StringValue }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.protobuf.StringValue mime_type */ 6:
                    message.mimeType = wrappers_2.StringValue.internalBinaryRead(reader, reader.uint32(), options, message.mimeType);
                    break;
                default:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.mimeType)
            wrappers_2.StringValue.internalBinaryWrite(message.mimeType, writer.tag(6, runtime_1.WireType.LengthDelimited).fork(), options).join();
...
class ListArtifactsResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("github.actions.results.api.v1.ListArtifactsResponse", [
            { no: 1, name: "artifacts", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => exports.ListArtifactsResponse_MonolithArtifact }
        ]);
    }
    create(value) {
